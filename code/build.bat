...
set CustomRoot=%cd%
set BuildTarget=%CustomRoot%\main.cpp

set Includes=%CustomRoot%\external
...
set CommonLinkerFlags= -incremental:no -opt:ref user32.lib Winmm.lib opengl32.lib Gdi32.lib
